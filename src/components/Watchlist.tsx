...
import { getPriceBadgeColor, getPriceColor, formatChangePrice } from '@/utils/format-utils'
                                ...
                                {item.marketData ? (
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <span className={`inline-flex items-center gap-1 text-sm font-bold px-3 py-1 rounded-full ${getPriceBadgeColor(item.marketData.changePrice)}`}>
                                            ...
                                            <span className={`text-sm font-semibold ${getPriceColor(item.marketData.changePrice)}`}>
                                                {formatChangePrice(item.marketData.changePrice)}원
                                            </span>
                                        </div>
                                    </div>
                                ) : (
